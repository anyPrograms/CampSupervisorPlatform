...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='营员表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='counselor表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='director表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='staff表';
...
CREATE TABLE `bunk` (
  ...
  PRIMARY KEY (`bunk_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='bunk表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='location表';
...
) ENGINE = InnoDB CHARSET = utf8mb4 ROW_FORMAT = Dynamic COMMENT='counselor_elective_map表';
...
) ENGINE = InnoDB CHARSET = utf8mb4 ROW_FORMAT = Dynamic COMMENT='student_elective_schedule_map表';
...
) ENGINE = InnoDB CHARSET = utf8mb4 ROW_FORMAT = Dynamic COMMENT='counselor_bunk_map 表';
